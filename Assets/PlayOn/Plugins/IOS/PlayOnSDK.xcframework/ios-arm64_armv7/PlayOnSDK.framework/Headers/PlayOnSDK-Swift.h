...
SWIFT_CLASS("_TtC9PlayOnSDK7Network")
...
SWIFT_PROTOCOL("_TtP9PlayOnSDK24NetworkConditionProtocol_")
@protocol NetworkConditionProtocol
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) id <NetworkConditionProtocol> _Nonnull shared;)
+ (id <NetworkConditionProtocol> _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, copy) void (^ _Nullable networkStatusChangedCompletion)(enum Status);
@property (nonatomic, readonly) enum Status networkStatus;
@property (nonatomic, readonly) BOOL isReachable;
@end


SWIFT_CLASS("_TtC9PlayOnSDK23NetworkConditionService")
@interface NetworkConditionService : NSObject <NetworkConditionProtocol>
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) id <NetworkConditionProtocol> _Nonnull shared;)
+ (id <NetworkConditionProtocol> _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, copy) void (^ _Nullable networkStatusChangedCompletion)(enum Status);
@property (nonatomic, readonly) enum Status networkStatus;
